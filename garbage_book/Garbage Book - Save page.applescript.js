...
var newName = (() => {
    let firstLine = frontDocument.text.lines[0].contents();
    let slug = firstLine.replace(annoyingCharacters, "_").substring(0, slugLength).replace(trailingJunk, "");
    ...
    return `${gbookDir}/${timestamp} ${slug}.txt`;
})();
